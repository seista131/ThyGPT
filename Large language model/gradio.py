...
def setup():
    ...
    # 先读取embedding模型
    embeddings = HuggingFaceEmbeddings(model_name="/root/autodl-tmp/text2vec-large-chinese",
...
with gr.Blocks() as demo:
    #    github_banner_path = 'autodl-tmp/thy.png'
    #   gr.HTML(f'<p align="center"><a href="https://github.com/facebookresearch/llama"><img src={github_banner_path} width="700"/></a></p>')
